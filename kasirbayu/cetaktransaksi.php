...
<body>
        ...
        <?php
            ...
            $sql = $koneksi->query("SELECT * FROM kasirpenjualan ORDER BY PenjualanID DESC LIMIT 1");
        ...
        ?>
               <p>ID Transaksi: <?php echo $data['PenjualanID']?></p>
                ...
                <?php
                    $sql2 = $koneksi->query("SELECT * FROM kasirpenjualan WHERE PelangganID = '".$data['PenjualanID']."'");
                    ...
                    <table class="table">
                        ...
                        <?php
                          ...
                          $sql3 = $koneksi->query("SELECT * FROM kasirdetailpenjualan WHERE DetailID = '" . $data['PenjualanID'] . "'");
                        ...
                        ?>
                            <tr>
                              <td>
                              <?php
                                $sql4 = $koneksi->query("SELECT * FROM kasirproduk WHERE ProdukID = '" . $data3['ProdukID'] . "' ");
